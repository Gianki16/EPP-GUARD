...
| 3 | Estudiante de la facultad (rol "supervisor") | Subir 3 fotos de obra, recibir las alertas y revisar la evidencia registrada (imagen + hora + confianza) | **SÍ** | Verificó que cada incumplimiento quedó registrado. Le pareció clara la evidencia para "respaldar ante una inspección". |
